...
from tasb_capture_v2 import LayerCapture, LlamaAttentionCapture
from tasb_sampler_v2 import sample, SamplerConfig, VALID_BACKENDS
...
def test_t7_convergence_to_softmax():
    ...
    from tasb_sampler_v2 import _compute_logits
